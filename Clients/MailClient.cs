    ...
    public class MailClient: IMailClient
    {
        ...
        public async Task sendResetPassword(string to_, string token){
            ...
            emailMessage.Body = new TextPart(MimeKit.Text.TextFormat.Html){
                Text= String.Format("<p>Hi,</p><p>You have requested a password reset email.</p><p></p> <p>Please visit the following URL:</p> <a href=\"https://new2me.herokuapp.com/auth/reset-password?token={0}\">Reset Password Link</a> <p>This link will expire in 24 hours.</p>", token)
            };
